...
impl<'a> SimpleState for GamePauseState {
    fn on_start(&mut self, data: StateData<GameData>) {
        // load the pause_menu.ron prefab then instantiate it
        let world = data.world;
        self.root =
            Some(world.exec(|mut creator: UiCreator<'_>| creator.create("pause_menu.ron", ())));
    }
        ...
        match event {
            ...
            StateEvent::Ui(UiEvent {
                ...
                if Some(target) == self.resume_button {
                    ...
                    // below that with a new MenuState state.
                    ...
                    log::info!("[Trans::Pop] Closing Pause Menu!");
                    log::info!("[Trans::Switch] Switching to MenuState!");
